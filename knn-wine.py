...
#plt.show()
plt.savefig("wine-KNN-CV_Fscores.png")
plt.close()
...
#knnplot.show()
knnplot.savefig("wine-KNN-LearningCurve.png")
plt.close()
...
print("--------------------------------------------------")
#print("F1 score:", f1_score(y_test, test_predict,average='micro'))
#print("Precision:", precision_score(y_test, test_predict,average='micro'))
#print("Recall:",recall_score(y_test, test_predict,average='micro'))
...
#plt.show()
plt.savefig("wine-KNN-confusionMatrix.png")
plt.close()
...
#plt.show()
#plt.savefig("wine-KNN-roc_curve.png")
#plt.close()

from sklearn.metrics import roc_auc_score
r_a_score = roc_auc_score(y_train, y_scores, average='micro')
...
plt.savefig("wine-KNN-validation_auc.png")
#pyplot.show()
plt.close()
