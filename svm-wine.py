...
ax.set_xlabel("Gamma")
ax.set_ylabel('C')
plt.savefig("wine-SVM-rbf-C_gammma-optimizaton.png")
#plt.show()
plt.close()
...
svmrbfplot=plot_learning_curve(clf, "SVM with RBF kernel, gamma=" + str(best_gamma), X, y)
svmrbfplot.savefig("wine-SVMRbfLearningCurve.png")
...
#plt.show()
plt.savefig("wine-SVM-rbf-confusionMatrix.png")
plt.close()
...
#plt.show()
plt.savefig("wine-SVM-rbf-roc_curve.png")
plt.close()
...
plt.savefig("wine-SVM-rbf-auc.png")
#pyplot.show()
plt.close()
...
ax.set_ylabel('C')
#plt.show()
plt.savefig("wine-SVM-sigmoid-C_gammma-optimizaton.png")
plt.close()
...
svmsigplot=plot_learning_curve(clf, "SVM with sigmoid kernel, gamma=" + str(best_gamma), X, y)
svmsigplot.savefig("wine-SVMSigmoidLearningCurve.png")
...
plt.xlabel('Predicted label');
#plt.show()
plt.savefig("wine-SVM-sigmoid-confusionMatrix.png")
plt.close()
...
plot_roc_curve(false_positive_rate, true_positive_rate)
#plt.show()
plt.savefig("wine-SVM-sigmoid_sig_roc_curve.png")
plt.close()
