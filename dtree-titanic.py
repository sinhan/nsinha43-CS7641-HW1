...
#plt.show()
plt.savefig("titanic-DTree-CV_Fscores.png")
plt.close()



with open('titanic-Dtree-tree.dot', 'w') as dotfile:
    export_graphviz(
...
subprocess.call(['dot','-Tpng','titanic-Dtree-tree.dot','-o','titanic-Dtree-tree.png'])
...
#dplot.show()
dplot.savefig("titanic-DTree-LearningCurve.png")
dplot.close()
...
#plt.show()
plt.savefig("titanic-Dtree-ConfusionMatrix.png")
plt.close()
...
plt.draw()
plt.savefig("titanic-Dtree-featureImportance.png")
#plt.show()
plt.close()
...
#plt.show()
plt.savefig("titanic-Dtree-roc_curve.png")
plt.close()
...
#plt.show()
#pyplot.show()
#plt.savefig("titanic-Dtree-Auc.png")
pyplot.savefig("titanic-Dtree-Auc.png")
#plt.show()
plt.close()
