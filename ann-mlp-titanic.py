...
#dplot.show()
dplot.savefig("titanic-ann_learning_curve.png")
dplot.close()
...
plt.savefig('titanic-confusion_ann.png')
#plt.show()
plt.close()
...
#plt.show()
plt.savefig("titanic-ann-roc_curve.png")
plt.close()
...
plt.ylabel('Cost')
plt.xlabel('Epochs')
plt.savefig('titanic-ann-cost_curve.png')
plt.close()
