...
#plt.show()
plt.savefig("wine-DTree-CV_Fscores.png")
plt.close()



with open('wine-Dtree-tree.dot', 'w') as dotfile:
    export_graphviz(
...
subprocess.call(['dot','-Tpng','wine-Dtree-tree.dot','-o','wine-Dtree-tree.png'])
...
#dplot.show()
dplot.savefig("wine-DTree-LearningCurve.png")
dplot.close()
...
#plt.show()
plt.savefig("wine-Dtree-ConfusionMatrix.png")
plt.close()
...
plt.draw()
plt.savefig("wine-Dtree-featureImportance.png")
#plt.show()
plt.close()
...
#plt.show()
plt.savefig("wine-Dtree-roc_curve.png")
plt.close()
...
#plt.show()
#pyplot.show()
#plt.savefig("wine-Dtree-Auc.png")
pyplot.savefig("wine-Dtree-Auc.png")
#plt.show()
plt.close()
