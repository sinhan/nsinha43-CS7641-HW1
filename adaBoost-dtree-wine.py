...
#plt.show()
plt.savefig("wine-adaboost_CV_Fscores.png")
plt.close()
...
adbplot.savefig("wine-adaboost-LearningCurve.png")
#plt.show()
plt.close()
...
#plt.show()
plt.savefig("wine-adaboost-confusionmatrix.png")
plt.close()
#print("confusion_matrix:",confusion_matrix(y_test, test_predict))
...
plt.savefig("wine-adaboost_roc_curve.png")
#plt.show()
plt.close()
...
#plt.show()
pyplot.savefig("wine-adaboost_auc_curve.png")#
plt.close()
