...
#plt.show()
plt.savefig("titanic-KNN-CV_Fscores.png")
plt.close()
...
#knnplot.show()
knnplot.savefig("titanic-KNN-LearningCurve.png")
plt.close()
...
#plt.show()
plt.savefig("titanic-KNN-confusionMatrix.png")
plt.close()
...
#plt.show()
plt.savefig("titanic-KNN-roc_curve.png")
plt.close()
...
plt.savefig("titanic-KNN-validation_auc.png")
#pyplot.show()
plt.close()
