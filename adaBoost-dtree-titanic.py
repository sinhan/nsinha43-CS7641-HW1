...
#plt.show()
plt.savefig("titanic-adaboost_CV_Fscores.png")
plt.close()
...
adbplot.savefig("titanic-adaboost-LearningCurve.png")
#plt.show()
plt.close()
...
#plt.show()
plt.savefig("titanic-adaboost-confusionmatrix.png")
plt.close()
#print("confusion_matrix:",confusion_matrix(y_test, test_predict))
...
plt.savefig("titanic-adaboost_roc_curve.png")
#plt.show()
plt.close()
...
plt.show()
#plt.savefig("titanic-adaboost_auc_curve.png")#
plt.close()
