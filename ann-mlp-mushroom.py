...
#dplot.show()
dplot.savefig("mushrooms-ann_learning_curve.png")
dplot.close()
...
plt.savefig('mushrooms-confusion_ann.png')
#plt.show()
plt.close()
...
#plt.show()
plt.savefig("mushrooms-ann_roc_curve.png")
plt.close()
...
#clf = MLPClassifier(activation = 'logistic', alpha = 0.01, hidden_layer_sizes = (100,), learning_rate = 'constant', solver = 'lbfgs', random_state=0)
#clf = MLPClassifier(activation = 'logistic', alpha = 0.01, hidden_layer_sizes = (100,), learning_rate = 'constant', solver = 'lbfgs', random_state=0)
clf = MLPClassifier(activation = 'tanh', alpha = 0.01, hidden_layer_sizes = (100,), learning_rate = 'constant', solver = 'sgd', random_state=0)
clf.epochs = 100
clf=clf.fit(X_train, y_train)
...
plt.ylabel('Cost')
plt.xlabel('Epochs')
plt.savefig('mushrooms-ann-cost_curve.png')
#plt.show()
plt.close()
