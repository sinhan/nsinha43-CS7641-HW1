...
ax.set_xlabel("Gamma")
ax.set_ylabel('C')
plt.savefig("mushrooms-SVM-rbf-C_gammma-optimizaton.png")
#plt.show()
plt.close()
...
#plt.show()
plt.savefig("mushrooms-SVM-rbf-confusionMatrix.png")
plt.close()
...
#plt.show()
plt.savefig("mushrooms-SVM-rbf-roc_curve.png")
plt.close()
...
plt.savefig("mushrooms-SVM-rbf-auc.png")
#pyplot.show()
plt.close()
...
ax.set_ylabel('C')
#plt.show()
plt.savefig("mushrooms-SVM-sigmoid-C_gammma-optimizaton.png")
plt.close()
...
plt.xlabel('Predicted label');
#plt.show()
plt.savefig("mushrooms-SVM-sigmoid-confusionMatrix.png")
plt.close()
...
plot_roc_curve(false_positive_rate, true_positive_rate)
#plt.show()
plt.savefig("mushrooms-SVM-sigmoid_sig_roc_curve.png")
plt.close()
